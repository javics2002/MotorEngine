...
int main() {
	...
	ogreMgr->createCamera(camJ1, 5,10000,true,0);
	ogreMgr->setCameraInfo(camJ1, 0, 0, 500, 0, 0, -1);

	//ogreMgr->setViewportDimension(camJ1, 0, 0, 0.3, 1);

	std::string camJ2 = "CameraJugador2";
	ogreMgr->createCamera(camJ2, 5, 10000, true,1);
	ogreMgr->setCameraInfo(camJ2, 0, 300, 500, 0, 0, -1);

	//ogreMgr->setViewportDimension(camJ2, 0.5, 0, 0.3, 1);

	

	ogreMgr->createNewLight("Luz", 0, 500, 500, 0, -1, -1);
	ogreMgr->scene1();
