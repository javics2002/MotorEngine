    ...
    */
    ...
    public:        
        ...
        */
        ...
        @param sceneName Name of scene that will be charged
		@param awake Names of methods to execute before reading the entities
        @param start Names of methods to execute after reading the entities
